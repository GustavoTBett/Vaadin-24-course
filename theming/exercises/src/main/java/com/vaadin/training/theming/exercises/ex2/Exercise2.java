...
public class Exercise2 extends VerticalLayout {
    ...
    private void createEmailFields() {
        ...
        confirmField.addClassName("emailField");
    ...
    private void createCheckBoxes() {
        ...
        styledCheckbox.addClassName("styledCheckbox");
    ...
    private void createComboBoxes() {
        ...
        yellowBgColorCombo.setClassName("yellowBgColorCombo");

        // TODO Style the yellowBgColorCombox popup overlay so it has yellow background
        yellowBgColorCombo.setOverlayClassName("overlayYellowBgColorCombo");
    ...
    private void createExampleTextSpan() {
        ...
        span.addClassNames(LumoUtility.FontSize.LARGE, LumoUtility.FontWeight.BOLD, LumoUtility.Border.ALL, LumoUtility.BorderRadius.SMALL,
                LumoUtility.BorderColor.ERROR, LumoUtility.Margin.LARGE, LumoUtility.Padding.MEDIUM);
